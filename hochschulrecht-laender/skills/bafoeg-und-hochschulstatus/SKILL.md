...
Arbeitsfokus: **BAföG Und Hochschulstatus**. Prüfe diese Anker am Sachverhalt; ergänze nur Normen, die denselben Output, dieselbe Frist oder dieselbe Beweisfrage tragen:
...
## Fachkern: BAföG Und Hochschulstatus
...
Leistungsnachweis, Fachwechsel, Urlaubssemester, Exmatrikulation, Rückforderung und Fristen.
...
- **Erste Trennlinie:** Ist das Problem wirklich BAföG Und Hochschulstatus, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
- Primäre Anker: BAföG; Hochschulrecht.
...
Erzeuge bevorzugt: BAföG-Schnittstellenvermerk. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.
