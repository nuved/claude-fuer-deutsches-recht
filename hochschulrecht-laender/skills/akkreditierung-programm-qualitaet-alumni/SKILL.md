...
Arbeitsfokus: **Akkreditierung: Programm und System**. Prüfe diese Anker am Sachverhalt; ergänze nur Normen, die denselben Output, dieselbe Frist oder dieselbe Beweisfrage tragen:
...
## Fachkern: Akkreditierung: Programm und System
...
- **Konkreter Auftrag:** Prüft Programm-/Systemakkreditierung, Auflagen, Studiengangsqualität und Gremienfolgen.
- **Erste Trennlinie:** Ist das Problem wirklich Akkreditierung: Programm und System, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
