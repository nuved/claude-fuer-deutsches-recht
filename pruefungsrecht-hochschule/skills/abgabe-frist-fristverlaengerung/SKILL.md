...
Fristberechnung, Serverzeit, Post, elektronisches System, Dateiformat, Defekt und Nachweis.
...
- **Konkreter Auftrag:** Prüft Abgabe, Frist, Upload und Zugang.
- **Erste Trennlinie:** Ist das Problem wirklich Abgabe Frist Upload, oder liegt vorgelagert eine andere Entscheidung, Zuständigkeit oder Frist vor?
...
- Primäre Anker: Prüfungsordnung; VwVfG Zugang.
...
Erzeuge bevorzugt: Abgabecheck. Am Ende immer drei Zeilen: **Frist**, **fehlende Quelle**, **nächster sicherer Schritt**.
