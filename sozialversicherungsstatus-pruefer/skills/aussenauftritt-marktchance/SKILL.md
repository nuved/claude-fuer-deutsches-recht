...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Außenauftritt und Marktchance` und löse die dort angelegte Fachfrage; arbeite mit konkreten Tatbestandsmerkmalen, Beweisfragen und dem unmittelbar benötigten Arbeitsprodukt. Routingfragen bleiben Hilfsmittel, wenn Frist, Zuständigkeit oder Verfahrensart offen sind.
...
## Fachkern: Außenauftritt und Marktchance
...
- Tritt die Person am Markt unter eigenem Namen auf?
- Hat sie eigene AGB, Angebote, Preislisten, Versicherungen und Referenzen?
- Oder erscheint sie nach außen als Teil des Auftraggebers?
- Welche Indizien sind substantiell und welche nur nachträglich gebaut?
...
**Mindest-Output:** Marktauftritt-Check mit Belegen, Schwächen und Gewichtung.
