...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Audit-Selbsttest Unternehmen` und löse die dort angelegte Fachfrage; arbeite mit konkreten Tatbestandsmerkmalen, Beweisfragen und dem unmittelbar benötigten Arbeitsprodukt. Routingfragen bleiben Hilfsmittel, wenn Frist, Zuständigkeit oder Verfahrensart offen sind.
...
## Fachkern: Audit-Selbsttest Unternehmen
...
- Welche Abteilungen nutzen externe Personen?
- Welche Serienverträge und Einsatzmodelle sind kritisch?
- Welche Daten liefern Einkauf, HR, Finance, IT und Fachbereich?
- Welche Fälle müssen vor der nächsten Betriebsprüfung saniert werden?
...
**Mindest-Output:** Auditbericht mit Fallliste, Risikoklassen, Maßnahmen und Ownern.
