...
Arbeitsakte zum Plugin `fachanwalt-gewerblicher-rechtsschutz`.
...
- **Hauptkonflikt 4 — UWG gegen RosenGarten24.de:** Influencer-Posts mit Bezug zur Marke; Abmahnung nach § 8 UWG; Rechtsstreit OLG Karlsruhe 6 U 41/26.
- **Hauptkonflikt 5 — Lizenzstreit Fonderie Roussel SAS:** Kündigung des Lizenzvertrags mit dem französischen Hersteller; Streit um nachvertragliches Wettbewerbsverbot und Restbestandsablauf (4.200 Stück).
- **Hauptkonflikt 6 — Domain-Streit:** Konkurrent registriert `rosenmanufaktur.de`; DENIC-Dispute-Verfahren beantragt.
- **Vertretung:** Patentanwalts- und Rechtsanwaltskanzlei Dr. Volkmar Trautmann & Coll., Mannheim.
- **Aktenzeichen:** LG Mannheim 7 O 88/26 · OLG Karlsruhe 6 U 41/26 · EUIPO BoA R 1322/26-2 · DPMA Marke 30 2026 011 442.
...
|---|---|---|
| Mandatsaufnahme und Erstanalyse | 01, 02 | Schutzrechtsportfolio, Fallkonstellation, Vollmacht |
| 3D-Markenrecht und Unterscheidungskraft | 03, 04 | Art. 7 UMV, § 3 MarkenG, EUIPO-Praxis zu Formmarken |
| Verletzungsklage und einstweilige Verfügung | 05, 06 | § 14 MarkenG, §§ 935 ff. ZPO, Dringlichkeit |
| Schadensberechnung Lizenzanalogie | 07 | § 14 Abs. 6 MarkenG, Dreifachberechnung, Bestimmung des Lizenzsatzes |
| EUIPO-Nichtigkeitsverfahren | 08, 09 | Art. 59, 60 UMV, Boards of Appeal R 1322/26-2 |
| Designrecht und Neuheitsprüfung | 10, 11 | § 2 DesignG, Art. 5 GGV, Vintage-Katalog 1962 |
| UWG — Rufausbeutung und Schleichwerbung | 12, 13 | § 4 Nr. 3 UWG, § 5a UWG Influencer, § 8 UWG Abmahnung |
| Lizenzvertragsrecht und Nachbindung | 14, 15 | Lizenzvertragskündigung, nachvertragliches Wettbewerbsverbot, Restbestand |
| Domain-Streit / DENIC-Dispute | 16 | DENIC-Dispute-Richtlinien, UDRP-Grundsätze |
| Verteidigungsstrategie EUIPO | 17 | Gegenvortrag Unterscheidungskraft, Verkehrsdurchsetzung |
| Beweismittel und Rechercheergebnisse | 18 | Testkäufe, eidesstattliche Versicherungen, Gutachterbeauftragung |
| Vergleichsverhandlungen | 19 | Außergerichtliche Einigung, Lizenzlösung, Rückruf |
| Prozesstaktik LG Mannheim | 20 | Klage-, Beweis- und Antragsstrategie |
| Vollstreckung und Ordnungsmittelantrag | 21 | § 890 ZPO, Ordnungsgeld, Zwangsvollstreckung |
| Gesamtstrategie und Zeitachse | 22 | Parallelverfahren, Prioritäten, Mandantenkommunikation |
...
| Typ | Datei | Inhalt |
|---|---|---|
| DOCX | [`docx/schriftsatz_klage_markenverletzung_lg_mannheim.docx`](docx/schriftsatz_klage_markenverletzung_lg_mannheim.docx) | Klageschrift LG Mannheim 7 O 88/26 |
| DOCX | [`docx/schriftsatz_euipo_beschwerde_r_1322_26_2.docx`](docx/schriftsatz_euipo_beschwerde_r_1322_26_2.docx) | EUIPO-Beschwerdeschrift BoA R 1322/26-2 |
| DOCX | [`docx/abmahnung_uwg_rosengarten24.docx`](docx/abmahnung_uwg_rosengarten24.docx) | UWG-Abmahnung an RosenGarten24.de |
| XLSX | [`xlsx/schadensberechnung_lizenzanalogie.xlsx`](xlsx/schadensberechnung_lizenzanalogie.xlsx) | Schadensberechnung § 14 Abs. 6 MarkenG |
| XLSX | [`xlsx/bestands_und_vertriebszahlen.xlsx`](xlsx/bestands_und_vertriebszahlen.xlsx) | Bestands- und Vertriebsstatistik, Restbestand Fonderie Roussel |
| EML | [`eml/anschreiben_flowerworld_ag_abmahnung.eml`](eml/anschreiben_flowerworld_ag_abmahnung.eml) | Erstabmahnung an FlowerWorld AG |
| EML | [`eml/euipo_ladung_nichtigkeitsverfahren.eml`](eml/euipo_ladung_nichtigkeitsverfahren.eml) | EUIPO-Ladung zum Nichtigkeitsverfahren |
| EML | [`eml/korrespondenz_fonderie_roussel_kuendigung.eml`](eml/korrespondenz_fonderie_roussel_kuendigung.eml) | Kündigungsschreiben Lizenzvertrag |
